...
function createHeader() {
  ...
  header.classList.add("col-2", "px-0", "bg-black", "pt-4");
...
function createAside() {
  ...
  notifications.innerHTML = `<div class="container mt-5 text-gray notifications ps-1 pe-0">
            ...
            <div class="d-flex justify-content-between gap-1 mt-3">
              ...
              <p class="time d-none d-lg-block">8 ore</p>
            </div>
            <div class="d-flex justify-content-between gap-1 mt-3">
              <div class="d-flex gap-2">
                <img
              ...
              <p class="time d-none d-lg-block">3 giorni</p>
            </div>
          </div>`;
